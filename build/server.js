...
api.use(_expressWinston2.default.logger({
  ...
  format: _winston2.default.format.combine(_winston2.default.format.colorize(), _winston2.default.format.json()),
  meta: true
}));

api.use("/api/v1", [_routes.MainRoute, _routes.EventRoute, _routes.SermonRoute, _routes.BlogRoute]);
